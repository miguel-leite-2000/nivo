            ...
            <div className="bg-zinc-900/20 border-[1px] border-zinc-800 pt-5 rounded-[8px]">
              <div className="flex flex-col gap-6 px-5">
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex justify-between items-center">
                    <h3 className="text-sm text-zinc-300 font-medium">Storage amount</h3>
                    <p className="text-xs text-zinc-300">2TB <span className="text-zinc-500">/ 6TB</span></p>
                  </div>
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex justify-between items-center">
                    <h3 className="text-sm text-zinc-300 font-medium">Monthly bandwidth</h3>
                    <p className="text-xs text-zinc-300">23TB <span className="text-zinc-500">/ 50TB</span></p>
                  </div>
                  <div className="bg-zinc-900 w-full h-2 rounded-[42px]">
                    <Progress
                      value={100}
